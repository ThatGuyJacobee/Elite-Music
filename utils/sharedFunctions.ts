    ...
    if (search.playlist) {
      embed.setDescription(
        translate(interaction, "queue.importedPlaylistStarted", {
          ...
          link: search.tracks[0].playlist!.url ? buildTrackLinkText({ url: search.tracks[0].playlist!.url }, interaction) : "",
...
export function skipCurrentTrack(interaction: GuildCommandInteraction, queue: any, user: any): { embeds: EmbedBuilder[] } {
