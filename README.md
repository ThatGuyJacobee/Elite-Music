...
3. Set `PLEX_AUTHTOKEN` to your Plex authentication token. You can obtain this by browsing the XML file for a library item. Please follow the [official Plex Support article](https://support.plex.tv/articles/204059436-finding-an-authentication-token-x-plex-token/) for step-by-step instructions. Once you have your token, place it into your `.env` file.
